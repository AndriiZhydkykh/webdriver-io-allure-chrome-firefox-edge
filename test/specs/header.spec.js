...
describe('Header testing', () => {
    xit('ID -2 Check that Product, Solution, Resources,Company,Pricing links in the header menu open dropdown menu when hover those', async () => {
        await HelperScripts.checkButtonsHaveDropdown();
    });
    xit('ID -3 Check that all item from Products dropdown menu on header to be able click', async () => { 
